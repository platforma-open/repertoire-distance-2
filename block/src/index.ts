...
export type RepertoireDistance2BlockContract = BlockContract;
export type RepertoireDistance2BlockOutputs  = BlockOutputs;
export type RepertoireDistance2BlockData     = BlockData;
export const RepertoireDistance2BlockPointer = BlockPointer;
